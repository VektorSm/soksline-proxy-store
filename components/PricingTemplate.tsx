...
export default function PricingTemplate({ data }: PricingTemplateProps) {
  ...
  const [activeCategoryId, setActiveCategoryId] = useState<string>(() =>
    resolveInitialCategory(copy.categories),
  );
  ...
  return (
    <div id={copy.slug} className={styles.page}>
      ...
      <Section bg="white" containerClassName={styles.plansSection}>
                  ...
                  <p className={styles.planPrice}>
                    {normalizedRotatingTier ? (
                      <span className={styles.rotatingPriceLabel}>
                        {normalizedRotatingTier.gb} GB —{' '}
                        {fmtUSD(Number(normalizedRotatingTier.pricePerGbText))}/GB (Total{' '}
                        {fmtUSD(normalizedRotatingTier.total)})
                      </span>
                    ) : (
                      <>
        ...
        <KycNotice className={styles.planKycNotice} locale={locale} />
