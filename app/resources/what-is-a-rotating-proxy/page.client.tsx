...
const CONTENT: Record<Locale, Content> = {
  ru: {
    ...
    lead: 'Ротационный резидентский прокси направляет ваш трафик через несколько реальных домашних IP-адресов. Это сохраняет приватность, автоматизирует смену IP и помогает избежать блокировок со стороны сайтов.',
  ...
  en: {
    ...
    lead: 'A rotating residential proxy routes your traffic through multiple real home IP addresses. It keeps your activity private, automates IP changes, and helps you avoid website blocks.',
