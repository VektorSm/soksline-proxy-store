...
const CONTENT: Record<Locale, Content> = {
  ru: {
    ...
    lead: 'Да. Каждый заказ прокси SoksLine позволяет выбрать локацию, которая лучше всего подходит под ваш сценарий. Укажите нужную страну при оформлении и управляйте трафиком без дополнительной настройки и задержек.',
  ...
  en: {
    ...
    lead: 'Yes. Every SoksLine proxy order lets you pick the location that fits your use case best. Choose the required country at checkout and manage traffic without extra setup or latency.',
