      ...
      textSections: [
        {
          id: 'basic',
          title: 'Basic',
          body: 'Подходит для личных проектов и тестовых запусков. Вы получаете выделенный статический IP с базовыми лимитами по трафику и управляете доступом через простой дашборд.',
        },
        {
          id: 'dedicated',
          title: 'Dedicated',
          body: 'Оптимален для регулярных задач с повышенными требованиями. Выделенный IPv4, гибкая настройка ASN и географии, безлимитный трафик и поддержка расширения скорости.',
        },
        {
          id: 'premium',
          title: 'Premium',
          body: 'Корпоративный уровень с кастомной ротацией, SLA и приоритетной поддержкой. Подходит для крупных пулов, где важна высочайшая стабильность и масштабируемость.',
        },
      ],
      ...
      textSections: [
        {
          id: 'basic',
          title: 'Basic',
          body: 'Ideal for pilots and side projects. You get a dedicated static IP with lightweight bandwidth allowances and simple dashboard management.',
        },
        {
          id: 'dedicated',
          title: 'Dedicated',
          body: 'Built for steady workloads that need reliability. Dedicated IPv4 with configurable ASN and geo, unlimited traffic, and available speed upgrades.',
        },
        {
          id: 'premium',
          title: 'Premium',
          body: 'Enterprise-grade delivery with custom rotation windows, contractual SLA, and priority support. Designed for large pools that demand maximum stability.',
        },
      ],
      ...
      textSections: [
        {
          ...
          body: 'Прокси не ограничены по объёму передаваемых данных — поддерживайте длительные сессии и интенсивный парсинг без рисков по достижению лимитов.',
        },
        {
          id: 'threads',
          title: '100 потоков',
          body: 'Одновременная работа до ста соединений с одной учётной записи помогает ускорить сбор данных и автоматизацию даже при плотных расписаниях.',
        },
        {
          id: 'speed',
          title: '100+ Mbps',
          body: 'Высокая пропускная способность сохраняет скорость загрузки страниц и стабильность соединений, даже когда трафик распределён на множество задач.',
        },
        {
          id: 'dedicated',
          title: 'Выделенный IP-адрес',
          body: 'Каждый IPv6-адрес закреплён за вами, что исключает пересечения с соседями и снижает вероятность блокировок со стороны целевых ресурсов.',
        },
        {
          id: 'geography',
          title: 'IPv6-адреса из США',
          body: 'Арендуйте пул адресов из американских дата-центров, чтобы работать с сервисами, требующими присутствия в США.',
        },
      ],
      ...
      textSections: [
        {
          ...
          body: 'Push large volumes of requests and sustain always-on sessions without worrying about overage fees or throttling.',
        },
        {
          id: 'threads',
          title: '100 Threads',
          body: 'Run up to one hundred concurrent connections per account so your crawlers and automation workflows finish faster.',
        },
        {
          id: 'speed',
          title: '100+ Mbps',
          body: 'Maintain quick page loads and reliable throughput even when your traffic is spread across multiple projects.',
        },
        {
          id: 'dedicated',
          title: 'Dedicated IP Address',
          body: 'Each IPv6 address is reserved for you, keeping neighbors out of your pool and reducing the chance of destination blocks.',
        },
        {
          id: 'geography',
          title: 'IPv6 Addresses from the US',
          body: 'Leverage US-based infrastructure to satisfy location requirements and maintain compliance with geo-sensitive platforms.',
        },
      ],
      ...
      textSections: [
        {
          ...
          body: '85+ миллионов резидентских IP в 180 странах помогают имитировать поведение реальных пользователей и обходить фильтры на любых площадках.',
        },
        {
          id: 'rotation',
          title: 'Гибкая ротация',
          body: 'Настраивайте смену адресов по таймеру или по API-событиям, чтобы поддерживать чистые сессии и сохранять высокий процент успешных запросов.',
        },
        {
          id: 'targeting',
          title: 'Точный таргетинг',
          body: 'Выбирайте страну и город, комбинируйте фильтры ASN и оператора для локализованных проверок, маркетинга и сбора данных.',
        },
        {
          id: 'performance',
          title: 'Скорость и стабильность',
          body: 'Неограниченная параллельность, sticky-сессии до 30 минут и пропускная способность до 1 Гбит/с обеспечивают плавную работу даже под нагрузкой.',
        },
        {
          id: 'tooling',
          title: 'Инструменты и поддержка',
          body: 'Панель управления, API, белые списки IP и помощь команды 24/7 помогают быстро интегрировать прокси в ваши процессы.',
        },
      ],
      note: KYC_POLICY.ru,
    },
      ...
      textSections: [
        {
          ...
          body: '85M+ residential IPs across 180 countries help you mirror real-user behavior and bypass filters on the sites that matter.',
        },
        {
          id: 'rotation',
          title: 'Flexible rotation',
          body: 'Trigger IP changes on a timer or via API events to maintain clean sessions and protect your success rates at scale.',
        },
        {
          id: 'targeting',
          title: 'Precise targeting',
          body: 'Pick country and city combinations, layer ASN and carrier filters, and localize your marketing, QA, or data-collection workflows.',
        },
        {
          id: 'performance',
          title: 'Performance you can trust',
          body: 'Unlimited concurrency, sticky sessions up to 30 minutes, and throughput up to 1 Gbps keep high-volume automation stable.',
        },
        {
          id: 'tooling',
          title: 'Tooling & support',
          body: 'Manage access through dashboards, APIs, and IP whitelists with round-the-clock help from our support engineers.',
        },
      ],
      note: KYC_POLICY.en,
    },
